...
{
	$branch=$_POST['branch'];
	$shortcode=$_POST['description'];
	
	$sql=mysqli_query($con,"insert into state(branchName,branchShortcode) values('$branch','$shortcode')");
...
<div class="controls">
<input type="text" placeholder="Enter Branch Name"  name="branch" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<td><?php echo htmlentities($row['branchShortcode']);?></td>
