...
{?>
					  			...
					  			<p class="mymutedtext"><?php echo htmlentities($num1);?> Tickets not Yet  Processed</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p class="mymutedtext"><?php echo htmlentities($num1);?> Tickets in process</p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p class="mymutedtext"><?php echo htmlentities($num1);?> Tickets closed</p>
                      </div>
