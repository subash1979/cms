...
$query=mysqli_query($con,"insert into tblcomplaints(userId,category,subcategory,complaintType,branch,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$branch','$complaintdetials','$compfile')");
...
<?php $sqlcomp=mysqli_query($con,"select companyName from company ");
while ($rwcomp=mysqli_fetch_array($sqlcomp)) {
  ?>
  <option value="<?php echo htmlentities($rwcomp['companyName']);?>"><?php echo htmlentities($rwcomp['companyName']);?></option>
<?php
}
?>
</select> 
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Priority of Complaint</label>
<div class="col-sm-4">
<select name="noc" required="required" class="form-control">
